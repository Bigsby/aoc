...
namespace AoC
{
    static class Program
    {
        ...
        static long Part1(IEnumerable<string> expressions) => EvaluateExpressions(false, expressions);

        static long Part2(IEnumerable<string> expressions) => EvaluateExpressions(true, expressions);
