...
namespace AoC
{
    class Program
    {
        ...
        static int Part1(IEnumerable<string> puzzleInput) => CountDifferences(puzzleInput, GetStringDifference1);
        ...
        static int Part2(IEnumerable<string> puzzleInput) => CountDifferences(puzzleInput, GetStringDifference2);
